...
public:
	...
	*/
	typedef boost::function<void(OgreNewt::Body*)> LeaveWorldCallback;
...
public:
	...
	*/
	...
	template<class c> void setLeaveWorldCallback( boost::function<void(c*, Body*)> callback, c *instancedClassPointer )
	{
		setLeaveWorldCallback( boost::bind(callback, instancedClassPointer, _1) );
	}
