...
namespace QuickGUI
{
	...
	public:
		...
		*/
		...
		/**
		* If a widget is detectable the GUIManager will assume any events passed to it are handled.
		* NOTE: Setting this false allows clicking GUI elements
