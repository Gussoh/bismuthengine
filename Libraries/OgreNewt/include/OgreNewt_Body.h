...
public:
	...
	*/
	...
	/*!
		...
		in world space.
	*/
	typedef boost::function<void(OgreNewt::Body*, const Ogre::Quaternion&, const Ogre::Vector3&)> TransformCallback;
	...
	*/
	typedef boost::function<void(OgreNewt::Body*, unsigned int)> autoactiveCallback;
    ...
    */
	...
	template<class c> void setAutoactiveCallback( boost::function<void(c*, Body*, unsigned int)> callback, c *instancedClassPointer )
	{
		setAutoactiveCallback( boost::bind(callback, instancedClassPointer, _1, _2) );
	}
